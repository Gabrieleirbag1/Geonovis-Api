#!/usr/bin/env python3
# filepath: /home/gab/Geonovis-Api/assets/scripts/conversion/msgpack_brotli_b64_to_json.py
...
def decode_file(input_file, output_file=None, pretty=False):
    """
    Decode a MessagePack+Brotli+Base64 encoded file back to JSON.
    ...
    try:
        ...
        # Step 2: Decompress with Brotli
        try:
            msgpacked = brotli.decompress(compressed)
        except Exception:
        ...
        try:
            ...
            return (False, "Invalid MessagePack data", None)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Decode MessagePack+Brotli+Base64 encoded files to JSON')
